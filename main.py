...
while True:
    ...
    cv2.putText(frame, "d:detection" , (20, 200), 2, 1, (150, 150, 50), 2)
    cv2.putText(frame, "c:camera" , (20, 230), 2, 1, (150, 150, 50), 2)
    cv2.putText(frame, "e:exit" , (20, 260), 2, 1, (150, 150, 50), 2)
    ...
    if k == ord('d'):
        ...
        """"""
        print(f"トータル：{elapsed_time1 + elapsed_time2 + elapsed_time3 + elapsed_time4 + elapsed_time5}")
